...
def main():
    ...
    parser.add_argument("--QG_model", default=None, type=str, required=True,
                        help="QG_model path")
    ...
    training_modelpath = args.QG_model
    ...
    for ele in tqdm(testing_data):
        ...
        try:
            ...
            res.append({"context" : context, "question" : question, "answers" : answers, "gen_question" : predictions_text.strip()})
            num+=1
    ...
    output_file = os.path.join(args.output_dir, "QG_eval.json")
